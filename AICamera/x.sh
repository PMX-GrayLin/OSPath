...
if [ "$1" = "aic" ]; then
	...
	if [ "$2" = "jobs" ]; then
		...
		if [ "$3" = "dp" ]; then
			...
			echo "arv-tool-0.8 control Width Height ExposureAuto ExposureTime GainAuto Gain TriggerMode TriggerSource TriggerSelector TriggerActivation"
			arv-tool-0.8 control Width Height ExposureAuto ExposureTime GainAuto Gain TriggerMode TriggerSource TriggerSelector TriggerActivation
